<?php
session_start();
if(isset($_SESSION['amaadhar'])){
  echo "<script>alert('Aadharid mismatched')</script>";
  unset($_SESSION['amaadhar']);
}
else if(isset($_SESSION['amudetails'])){
  echo "<script>alert('username or password mismatched')</script>";
  unset($_SESSION['amudetails']);
}
?>
  ...
  <body>
      ...
      <header>
        ...
        <nav>
          <ul>
            ...
            <li><a href="#" class="register-nav-link"> Login
            </a></li>
          </ul>
        </nav>
    ...
    <div class="banner">
      ...
      <div class="bannerright">
        ...
        <form action="adminlogin.php" method="POST" class="user">
          <div class="login">
            <input
              type="email"
              name="username"
